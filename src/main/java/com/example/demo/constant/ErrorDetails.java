...
public enum ErrorDetails {
	...
	INVALID_ACCOUNT_NUMBER(HttpStatus.BAD_REQUEST, 21, ServiceConstants.INVALID_ACCOUNT_NUMBER),
	NO_FEE_DUES_AVAILABLE(HttpStatus.BAD_REQUEST, 22, ServiceConstants.NO_FEE_DUES_AVAILABLE),
	FAILED_TO_VALIDATE_REQUEST_DATA(HttpStatus.BAD_REQUEST, 23, ServiceConstants.FAILED_TO_VALIDATE_REQUEST_DATA),
	DUPLICATE_STAFF_DETAILS(HttpStatus.BAD_REQUEST, 24, ServiceConstants.DUPLICATE_STAFF_DETAILS);
